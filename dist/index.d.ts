...
export { BicyclingLayer, Circle, DataLayer, DirectionsRenderer, GeoCoder, GroundOverlay, HeatmapLayer, InfoWindow, KmlLayer, Marker, NavigatorGeolocation, Ng2Map, Ng2MapComponent, Ng2MapModule, OptionBuilder, PlacesAutoComplete, Polygon, Polyline, StreetViewPanorama, TrafficLayer, TransitLayer };
