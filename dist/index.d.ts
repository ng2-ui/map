...
export { BicyclingLayer, Circle, CustomMarker, DataLayer, DirectionsRenderer, DrawingManager, GeoCoder, GroundOverlay, HeatmapLayer, InfoWindow, KmlLayer, Marker, NavigatorGeolocation, Ng2Map, Ng2MapComponent, Ng2MapModule, OptionBuilder, PlacesAutoComplete, Polygon, Polyline, StreetViewPanorama, TrafficLayer, TransitLayer, NG_MAP_CONFIG_TOKEN, ConfigOption };
