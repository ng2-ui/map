...
export class Circle extends BaseMapDirective {
  @Output() public centerChanged: EventEmitter<any> = new EventEmitter(); // generated by ngc-pre-compiler.js
  ...
  @Output() public radiusChanged: EventEmitter<any> = new EventEmitter(); // generated by ngc-pre-compiler.js
